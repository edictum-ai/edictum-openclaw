...
| #   | File                | Issue                | Violates                          |
| --- | ------------------- | -------------------- | --------------------------------- |
| 1   | `src/adapter.ts:42` | Description of issue | [CLAUDE.md — Security](CLAUDE.md) |

<details>
<summary>Details</summary>

**1. `src/adapter.ts:42` — Short title**
...
| #   | File                | Issue       | Violates                             |
| --- | ------------------- | ----------- | ------------------------------------ |
| 1   | `src/adapter.ts:15` | Description | [CLAUDE.md — Terminology](CLAUDE.md) |

<details>
<summary>Details</summary>

**1. `src/adapter.ts:15` — Short title**
...
| #   | File                    | Suggestion  |
| --- | ----------------------- | ----------- |
| 1   | `src/canonicalize.ts`   | Description |

<details>
<summary>Details</summary>

**1. `src/canonicalize.ts` — Short title**
...
| Check                  | Status   |
| ---------------------- | -------- |
| Governance bypass      | ✅ Clean |
| Parameter normalization| ✅ Clean |
| Unicode canonicalization| ✅ Clean |
| Fail-closed paths      | ✅ Clean |
| Terminology            | ✅ Clean |
| ...                    | ...      |
```
...
```markdown
- ✏️ `src/adapter.ts` (modified)
- ✨ `src/canonicalize.ts` (new)
...
`Security · Code quality · Terminology · Contract correctness · Parameter handling`
